...
tap a physician's button, and only that doctor's cell gets a free push
notification (ntfy or Telegram) or a real SMS (Twilio). It runs in the cloud, so it works from any
